...
Defines a date that is combined with a time of day. The time is based on a 24-hour day, with
...
is four digits, ranging from 1900 to 2079, which represents a year.

is two digits, ranging from 01 to 12, which represents a month in the
...
data types for new work. These types
