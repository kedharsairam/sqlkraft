...
, expressed in the boundary set by
...
hours, 31 minutes, and 23.647 seconds. For

, the maximum difference is 68 years, 19

days, 3 hours, 14 minutes, and 7 seconds.
...
is accurate only to the minute, seconds and milliseconds are always set

to

in the return value when
...
are adjacent and they differ in time by a hundred nanoseconds (.0000001 second). The
