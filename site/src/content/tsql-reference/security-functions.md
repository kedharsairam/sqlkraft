...
SCHEMA_NAME (Transact-SQL) sys.fn_builtin_permissions (Transact-SQL)

SESSION_USER (Transact-SQL) sys.fn_get_audit_file (Transact-SQL)

SUSER_ID (Transact-SQL) sys.fn_my_permissions (Transact-SQL)
