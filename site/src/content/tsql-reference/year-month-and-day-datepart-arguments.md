...
January 1 of any year defines the starting number for the
...
This table shows the return value for the

and

datepart

for '2007-04-21 ' for each

SET DATEFIRST argument. January 1, 2007 falls on a Monday. April 21, 2007 falls on a Saturday.

For U.S. English,

serves as the default. After setting DATEFIRST, use this suggested SQL statement for the

datepart table values:
