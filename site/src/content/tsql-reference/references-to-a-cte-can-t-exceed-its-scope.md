...
```sql
Msg 156, Level 15, State 1, Line 3. Incorrect syntax near the keyword 'WITH'.
```

```sql
Msg 208, Level 16, State 1, Line 1. Invalid object name 'inner_cte1_1'.
```
