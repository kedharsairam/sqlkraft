...
category: "system"
description: "This function returns all the events captured for the specified trace. The unique identifier for the primary key in the snapshots.trace_info table in the management The time that the trace started. The time that the trace ended."
