...
category: 'system'
description: 'Returns information about an event being traced. Transact-SQL syntax conventions Is the ID of the trace. , with no default. ID of the traced event ID numbers of all columns collected for each event This feature will be removed in a future version of SQL Server. Avoid using this feature in new development work, and plan to modify applications that currently use this feature. Use Extended Events ins'
...
SELECT
CAST
(0x5B007B0022004900640022003A0031002C002200440061007400610022003A00220045007800610
