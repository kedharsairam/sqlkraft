...
description: "The type of encryptor used: Certificate or Asymmetric Key. Is set to NULL if there is no encryptor specified. The name of the certificate or asymmetric key. Is set to NULL if there is no name specified permissions. The user should not be denied The following example returns the SQL Server managed backup to Microsoft Azure default configuration settings for the instance it is executed on:"
