...
category: "general"
description: "Creates a new profile for a replication agent. This stored procedure is executed at the The ID associated with the newly inserted profile. parameter. If specified, the value is set to the new profile ID. The type of replication agent."
