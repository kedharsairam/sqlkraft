...
category: "general"
description: "Closes and deallocates the cursor, and releases all associated resources; that is, it drops the temporary table used in support of in a tabular data stream (TDS) packet. value generated by SQL Server and returned by the An input value of applies toward all cursors on the current connection."
