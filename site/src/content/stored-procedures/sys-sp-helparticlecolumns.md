...
category: "general"
description: "Returns all columns in the underlying table. This stored procedure is executed at the Publisher on the publication database. For Oracle Publishers, this stored procedure is executed at the Transact-SQL syntax conventions The name of the publication that contains the article."
