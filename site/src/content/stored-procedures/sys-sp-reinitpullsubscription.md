...
Marks a transactional pull or anonymous subscription for reinitialization the next time the Distribution Agent runs. This stored procedure is executed at the Subscriber on the pull Transact-SQL syntax conventions The name of the Publisher database. subscriptions for reinitialization.
