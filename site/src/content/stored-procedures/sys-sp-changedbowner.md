...
category: "general"
description: "Changes the owner of the current database. Transact-SQL syntax conventions The login ID of the new owner of the current database. must be an already existing SQL Server login or Windows user. become the owner of the current database if it already has access to the database through an existing user security account within the database."
