...
category: "general"
description: "Executes the change data capture log scan operation. Transact-SQL syntax conventions Maximum number of transactions to process in each scan cycle. Maximum number of scan cycles to execute in order to extract all rows from the log."
