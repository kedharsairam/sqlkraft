...
Changes the settings for a SQL Server Agent schedule. Transact-SQL syntax conventions The identifier of the schedule to modify. The name of the schedule to modify.
