...
category: "general"
description: "This stored procedure cleans up history locally, and on the monitor server, based on retention Transact-SQL syntax conventions The primary ID for backup or the secondary ID for copy or restore."
