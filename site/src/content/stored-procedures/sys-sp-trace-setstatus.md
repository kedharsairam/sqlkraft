...
category: "general"
description: "Modifies the current state of the specified trace. Transact-SQL syntax conventions The ID of the trace to be modified. , with no default. The user employs this value to identify, modify, and control the trace. For information about retrieving the This feature will be removed in a future version of SQL Server."
