...
category: 'general'
description: 'Lists permissions for SQL Server Agent proxies to access subsystems. Transact-SQL syntax conventions The identification number of the proxy to list information for. The name of the proxy to list information for. The identification number of the subsystem to list information for.'
