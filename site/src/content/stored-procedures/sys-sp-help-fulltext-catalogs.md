...
category: "general"
description: "Returns the ID, name, root directory, status, and number of full-text indexed tables for the The name of the full-text catalog. this parameter is omitted or has the value , information about all full-text catalogs associated with the current database is returned. This feature will be removed in a future version of SQL Server. Avoid using this feature in new developm"
