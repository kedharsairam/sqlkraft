...
2016 (13.x) and later versions Deletes a specified backup snapshot from the specified database. Use this system stored procedure in conjunction with the identify and delete orphaned backup snapshots. For more information, see Backups for Database Files in Azure The name of the database containing the snapshot to be deleted, provided as a Unicode string. The URL of the snapshot to be deleted, provided as a Unicode string.
