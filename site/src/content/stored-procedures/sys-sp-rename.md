...
SQL analytics endpoint in Microsoft Fabric Changes the name of a user-created object in the current database. This object can be a table, index, column, alias data type, or Microsoft .NET Framework common language runtime (CLR) user-defined type. Transact-SQL syntax conventions in SQL Server and Azure SQL Database: (preview) in Azure Synapse Analytics: Some system objects and Transact-SQL syntax aren't supported in serverless SQL pools in
