...
category: "general"
description: "Lists all target servers in the specified group. If no group is specified, SQL Server returns information about all target server groups. Transact-SQL syntax conventions The name of the target server group for which to return information."
