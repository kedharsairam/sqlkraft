...
Inserts operations (rows) into the system table for target servers to download Transact-SQL syntax conventions The type of operation for the posted operation.
