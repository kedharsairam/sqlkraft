...
SQL Only members of the fixed server role can execute . View and modify replication security settings Secure the Distributor sp_adddistributor (Transact-SQL) Replication stored procedures (Transact-SQL) Related content
