...
Returns a list of attribute names and matching values for SQL Server, the database gateway, or the underlying data source. Used in ODBC only. Transact-SQL syntax conventions The integer ID of the attribute. Current setting of the attribute.
