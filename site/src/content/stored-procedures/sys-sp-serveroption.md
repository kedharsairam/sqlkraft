...
category: "general"
description: "Sets server options for remote servers and linked servers. Transact-SQL syntax conventions The name of the server for which to set the option. The option to set for the specified server."
