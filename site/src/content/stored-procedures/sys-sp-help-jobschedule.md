...
category: "general"
description: "Returns information about the scheduling of jobs used by SQL Server Management Studio to Transact-SQL syntax conventions The job identification number. must be specified, but both can't be specified. must be specified, but both can't be specified."
