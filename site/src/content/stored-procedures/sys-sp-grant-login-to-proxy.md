...
category: "general"
description: "Grants a security principal access to a proxy. The login name to grant access to. must be specified, or the stored The fixed server role to grant access to. must be specified, or the stored"
