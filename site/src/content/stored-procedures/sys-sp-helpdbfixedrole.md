...
category: "general"
description: "Returns a list of the fixed database roles. Transact-SQL syntax conventions The name of a fixed database role. is specified, only information about that role is returned; otherwise, a list and description of all fixed database roles is returned. Name of the fixed database role."
