...
commits, aborts, or forgets a specified transaction. Specifies the MSDTC transaction ID (transaction unit of work). Specifies operation to perform. Valid values are Arguments for extended stored procedures must be entered in the specific order as section.
