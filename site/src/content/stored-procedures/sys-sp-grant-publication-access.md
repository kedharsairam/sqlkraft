...
category: 'general'
description: 'Adds a login to the access list of the publication. This stored procedure is executed at the Publisher on the publication database. Transact-SQL syntax conventions The name of the publication to access. Identified for informational purposes only. Not supported. Future compatibility is not'
