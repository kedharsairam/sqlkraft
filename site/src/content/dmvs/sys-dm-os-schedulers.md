...
category: "os"
description: "Analytics Platform System (PDW) Returns one row per scheduler in SQL Server where each scheduler is mapped to an individual processor. Use this view to monitor the condition of a scheduler or to identify runaway tasks. For more information about schedulers, see the Thread and Task Architecture Guide Memory address of the scheduler. Is not nullable."
tags: ["os", "dmv"]
pubDate: 2026-05-29
...
Analytics Platform System (PDW) Returns one row per scheduler in SQL Server where each scheduler is mapped to an individual processor. Use this view to monitor the condition of a scheduler or to identify runaway tasks. For more information about schedulers, see the Thread and Task Architecture Guide Memory address of the scheduler. Is not nullable. ID of the node that the scheduler belongs to, also known
