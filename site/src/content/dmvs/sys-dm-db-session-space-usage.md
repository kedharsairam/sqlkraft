...
category: "io"
description: "Analytics Platform System (PDW) Returns the number of pages allocated and deallocated by each session for the database. In Azure SQL Database, the values are unique within a single database or an elastic pool, but Number of pages reserved or allocated for user Number of pages deallocated and no longer reserved for user objects by this session. Number of pages reserved or allocated for internal obj"
tags: ["io", "dmv"]
pubDate: 2026-05-29
