...
SQL Server 2014 (12.x) SP2 and later versions SQL database in Microsoft Fabric Returns information about statements submitted to an instance of SQL Server. Is the session ID executing the batch to be looked up. can be obtained from the following dynamic management objects: The type of event in the input buffer for the given session ID (SPID). Any parameters provided for the statement. The text of the statement in the input buffer for the given session ID
