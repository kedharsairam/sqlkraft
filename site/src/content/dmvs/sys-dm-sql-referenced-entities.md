...
category: "execution"
description: "SQL database in Microsoft Fabric Returns one row for each user-defined entity that is referenced by name in the definition of the specified referencing entity in SQL Server."
tags: ["execution", "dmv"]
pubDate: 2026-05-29
syntax: |
