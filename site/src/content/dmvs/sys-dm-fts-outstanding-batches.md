...
category: "full-text"
description: "SQL database in Microsoft Fabric Returns information about each full-text indexing batch. ID of the table ID that contains the full-text index The batch object memory address Crawl object memory address (parent object) Memory region memory address of the outbound share memory of the filter daemon host (fdhost.exe) Most recent error code for the batch Indicates whether this is a retry batch: Type o"
tags: ["full-text", "dmv"]
pubDate: 2026-05-29
syntax: |
