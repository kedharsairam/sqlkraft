...
category: "full-text"
description: "SQL database in Microsoft Fabric Returns information on the full-text catalogs that have some population activity in progress on ID of the database that contains the active full-text ID of the active full-text catalog. Address of memory buffers allocated for the population activity related to this full-text catalog."
tags: ["full-text", "dmv"]
pubDate: 2026-05-29
syntax: |
