...
topic: "event-classes"
description: "The event class describes cursor open events that occur in application programming interfac"
tags: ["event-classes","cursoropen-event-class"]
pubDate: 2025-12-01
---

The

event class describes cursor open events that occur in application

programming interface (API) cursors. Cursor open events occur when the SQL Server Database

Engine defines the SQL statement to be associated with the cursor and the cursor options, and

then populates the cursor.
