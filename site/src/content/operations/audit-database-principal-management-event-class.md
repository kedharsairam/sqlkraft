...
topic: "event-classes"
description: "The event class occurs when principals, such as users, are created, altered, or dropped from a databa"
tags: ["event-classes","audit-database-principal-management-event-class"]
pubDate: 2025-12-01
---
