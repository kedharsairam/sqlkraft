...
PreConnect:Completed Event

Class

Indicates when the Resource Governor classifier function finishes
...
Traces the output parameter values of remote procedure calls after
...
Indicates that the stored procedure has been removed from the
...
Indicates that a Transact-SQL statement within a stored procedure has
