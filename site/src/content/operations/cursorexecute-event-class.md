...
topic: "event-classes"
description: ""
tags: ["event-classes","cursorexecute-event-class"]
pubDate: "2025-12-01"
---
...
programming interface (API) cursors. Cursor execute events occur when Microsoft Database

Engine creates and populates a cursor from the execution plan created by a cursor prepare
