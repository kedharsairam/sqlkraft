---
title: "Showplan Text Event Class"
topic: "event-classes"
description: |
  Applies to:
...
XML Statistics Profile or Showplan XML event class.

When the Showplan Text event class is included in a trace, the amount of overhead will

significantly impede performance. To minimize this, limit use of this event class to traces that

monitor specific problems for brief periods of time. Showplan Text will not incur as much

overhead as other Showplan event classes.

When the Showplan Text event class is included in a trace, the BinaryData data column must be
