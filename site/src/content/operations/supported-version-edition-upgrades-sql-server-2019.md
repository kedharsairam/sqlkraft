---
title: "Supported version & edition upgrades SQL Server 2019"
topic: "upgrade"
description: |
  06/16/2025
  ...
  You can upgrade from SQL Server 2012 (11.x), SQL Server 2014 (12.x), SQL Server 2016 (13.x),

  and SQL Server 2017 (14.x). This article lists the su
tags:
  - "upgrade"
...
and SQL Server 2017 (14.x). This article lists the supported upgrade paths from these SQL

Server versions, and the supported edition upgrades for SQL Server 2019 (15.x).

Before upgrading from one edition of SQL Server 2019 (15.x) to another, verify that the
...
To upgrade to SQL Server 2019 (15.x), you must be running a supported operating
...
Cross-version instances of SQL Server 2019 (15.x) aren't supported. Version numbers of

the Database Engine components must be the same in an instance of SQL Server 2019
...
SQL Server, and then restore or attach them to a new instance of SQL Server (64-bit) if the
