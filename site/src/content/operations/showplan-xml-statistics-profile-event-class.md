---
title: "Showplan XML Statistics Profile Event Class"
topic: "event-classes"
description: |
  Applies to:
...
SQL statement. Include the Showplan XML Statistics Profile event class to identify the Showplan

operators on Microsoft SQL Server.

The Showplan XML Statistics Profile event class displays complete, compile-time data, and so

traces that contain this event class may incur significant performance overhead. To minimize

overhead incurred, limit use of this event class to traces that monitor specific problems for brief
