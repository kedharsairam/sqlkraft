...
The following updates apply to SQL Server 2025 (17.x) Cumulative Update (CU) 3.
...
The following updates apply to SQL Server 2025 (17.x) Cumulative Update (CU) 1.

. SQL Server 2025 (17.x) is fully supported on Red

Hat Enterprise Linux (RHEL) 10. For more information, see

Quickstart: Install SQL Server

and create a database on Red Hat

.

. SQL Server 2025 (17.x) is fully supported on Ubuntu 24.04. For
