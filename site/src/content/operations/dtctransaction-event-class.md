...
transactions coordinated through Microsoft Distributed Transaction Coordinator (DTC). This

includes transactions involving two or more databases in the same instance of the Database

Engine, or distributed transactions involving two or more instances of the Database Engine.
...
Binary representation of the Unit of Work ID

(UOW) that uniquely identifies this transaction
