...
ID of the placement. This is unique within the owning XML

schema component.

ID of the placed XML schema component.

1 = The default value is a fixed value. This value cannot be

overridden in an XML instance.
...
Default value if one is supplied. Is NULL if a default value is
