...
category: 'objects'
description: 'Returns one row per column that is a part of an'
...
## Returns one row per column that is a part of an
expression of a common language

runtime (CLR) table-valued function.
...
represents the position of this column in the ordering.
