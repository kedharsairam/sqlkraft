...
Analytics Platform System (PDW) SQL database in Microsoft Fabric Contains a row for each object that is a procedure of some kind, with For a list of columns that this view inherits, see 1 = Procedure is auto-executed at the server startup; otherwise, 0. Can only be set for procedures in the master Execution of this procedure is replicated.
