...
SQL) 06/18/2025 x) and later Azure SQL Database Azure SQL Managed Instance Azure Synapse Analytics Analytics Platform System (PDW) Removes an external data source used for PolyBase and data virtualization features. syntaxsql The name of the external data source to drop. To view a list of external data sources, use the system view. SQL Requires ALTER ANY EXTERNAL DATA SOURCE.
