...
Type of database scoped credential. Returns NULL for database

scoped credentials.

target_id

ID of the object that the database scoped credential is mapped to.


## Returns 0 for database scoped credentials
Requires
