...
category: 'xml'
description: 'Returns a row per XML schema component that is an Attribute-Wildcard ('
...
## Returns a row per XML schema component that is an Attribute-Wildcard (
of
