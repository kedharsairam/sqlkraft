...
Note: For information about tessellation schemes, see
...
The inherited columns has_filter and filter_definition appear

after the columns that are specific to spatial indexes.
