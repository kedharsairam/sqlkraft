...
2016 (13.x) and later versions SQL database in Microsoft Fabric Returns the Query Store options for this database. Indicates the desired operation mode of Query Store, explicitly set by user. Textual description of the desired operation mode of Query Store: Indicates the operation mode of Query Store. In addition to list of desired states required by the user, actual state Textual description of the actual
