...
topic: "collation"
description: "The data and transaction log files of a database can be detached and then reattached to the same or another instance of SQL Server."
tags: ["collation","database-detach-attach"]
pubDate: 2025-12-01
---
