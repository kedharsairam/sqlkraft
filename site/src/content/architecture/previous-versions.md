...
Compatibility level 90 is discontinued. For more information, see
...
server configuration option was discontinued beginning with SQL

Server 2008 (10.0.x). The article was removed from documentation.
