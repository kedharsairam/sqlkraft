    ...
    BEGIN;
                ...
                CASE
                    WHEN @get_task_info = 2 THEN
                        ...
                        (
                            ...
                            CROSS APPLY tasks_final.task_xml.nodes(N''[path]'') AS task_nodes (task_node)
                            WHERE
        ...
        BEGIN;   
            ...
            (
                ...
                CROSS APPLY trans_final.trans_xml.nodes('[path]') AS trans_nodes (trans_node)
            ) AS x
        ...
        BEGIN;
            ...
            (
                ...
                FROM #sessions AS s
                CROSS APPLY s.additional_info.nodes('[path]') AS agent_nodes (agent_node)
                WHERE
                    s.recursion = 1
            ) AS t
            WHERE
