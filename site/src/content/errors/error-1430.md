...
severity: "medium"
category: "io"
description: "Description command failed. 1430 16 No Database '%.*ls' is in an unstable state for removing database mirroring, so recovery may fail. Verify the data after recovery."
