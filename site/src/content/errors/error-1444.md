...
severity: 'medium'
category: 'connection'
description: 'Description 1444 10 Yes Bypassing recovery for database ''%ls'' because it is marked as a mirror database, which cannot be recovered. This is an informational message only. No user action is required. 1'
