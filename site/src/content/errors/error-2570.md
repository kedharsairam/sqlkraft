...
severity: 'medium'
category: 'corruption'
description: 'Invalid or out-of-range data may have been stored in the SQL Server database for the following reasons: Invalid data was inserted into SQL Server through remote procedure call (RPC) events. Other pote'
