...
Description to create the version. This might be timing related, so try the query again later. 3950 16 No Version store scan timed out when attempting to read the next row.
